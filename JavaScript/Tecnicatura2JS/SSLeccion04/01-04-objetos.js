...
let persona = {
    ...
    nombreCompleto: function(){ //Método a función en JavaScript
...
//for in y accedemos si objecto como si fuera un arreglo
for(propiedad in persona){
    console.log(propiedad);
    console.log(persona[propiedad]);
}
console.log('Cambiamos y eleminamos un error');
...
//Número 3: La función Objetc.values()
...
padre.telefono = '5492618282821'; //Una propiedad excludiva del objeto padre
console.log(padre);
...
console.log(persona4.nombreCompleto2('Lic.', '5492648383834'));
